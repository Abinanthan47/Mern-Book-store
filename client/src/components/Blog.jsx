        ...
        <div className="flex flex-wrap -m-4">
          ...
          <div className="p-4 md:w-1/3">
            <div className="h-full rounded-xl shadow-cla-blue bg-gradient-to-r from-indigo-50 to-blue-50 overflow-hidden">
              ...
              <div className="p-6">
                <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Productivity</h2>
                <h1 className="title-font text-lg font-medium text-gray-600 mb-3">Top 5 Books</h1>
                <p className="leading-relaxed mb-3">Top 5 productivity books to read to change your habits and stay productive.</p>
          ...
          <div className="p-4 md:w-1/3">
            <div className="h-full rounded-xl shadow-cla-violate bg-gradient-to-r from-pink-50 to-red-50 overflow-hidden">
              ...
              <div className="p-6">
                <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Fiction</h2>
                <h1 className="title-font text-lg font-medium text-gray-600 mb-3">Fiction Books to Read</h1>
                <p className="leading-relaxed mb-3">Some intresting & brainstroming fiction books to read in 2024.</p>
                <div className="flex items-center flex-wrap">
          ...
          <div className="p-4 md:w-1/3">
            <div className="h-full rounded-xl shadow-cla-pink bg-gradient-to-r from-fuchsia-50 to-pink-50 overflow-hidden">
              ...
              <div className="p-6">
                <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">Finance</h2>
                <h1 className="title-font text-lg font-medium text-gray-600 mb-3">Money Mangement</h1>
                <p className="leading-relaxed mb-3">Top books to read for money management and financial independent.</p>
                <div className="flex items-center flex-wrap">
