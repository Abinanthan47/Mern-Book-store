...
import bookpics from '../assets/hero.png'

const About = () => {
  return (
    <div className="bg-white relative   flex items-center  mt-52 justify-center overflow-hidden z-50 ">
        ...
        <div className="flex flex-col items-center justify-between lg:flex-row py-16">
          <div className=" relative ">
            ...
            <div className="lg:max-w-xl lg:pr-5 relative z-40">
              ...
              <h2 className="mb-6 max-w-lg text-5xl font-kanit leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                We make you look
                <span className="my-1 inline-block border-b-8 border-g4 bg-white px-4  text-g4 animate__animated animate__flash">different</span>
              </h2>
              <p className="text-base text-gray-700">A MERN Stack Book Inventory Project By Abinanthan .</p>
              <div className="mt-10 flex flex-col items-center md:flex-row">
                <a href="/" className="mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-green-500 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto">
                  View More</a>
