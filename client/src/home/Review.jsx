...
const Review = () => {
    return (
        ...
        <div className='  flex my-12 px-4 lg:px-24 '>
            <h2 className='text-4xl font-kanit items-center'>Reviews</h2>
            <div className="w-screen bg-gray-50">
                <div className="my-10 mx-auto max-w-screen-md px-10 py-16">
                    <div className="flex flex-col">
                        <div className="flex flex-col sm:flex-row">
                            <h1 className="max-w-sm text-3xl font-kanit text-black">
                                What people think <br />
                                about Booksy
                            </h1>
                            <div className="my-4 rounded-xl bg-white py-2 px-4 shadow sm:my-0 sm:ml-auto">
                                <div className="flex h-16 items-center text-2xl font-kanit  text-black">
                        ...
                        <div className="text-gray-700">
                            ...
                            <ul className="mb-6 mt-2 space-y-2">
                                ...
                                <li className="flex items-center text-sm font-medium">
                                    ...
                                    <div className="mr-4 h-2 w-96 overflow-hidden rounded-full bg-gray-300">
                                        <div className="h-full w-5/12 bg-yellow-400"></div>
                                    </div>
                                ...
                                <li className="flex items-center text-sm font-medium">
                                    ...
                                    <div className="mr-4 h-2 w-96 overflow-hidden rounded-full bg-gray-300">
                                        <div className="h-full w-2/12 bg-yellow-400"></div>
                                    </div>
                        ...
                        <button className="w-36 rounded-full bg-[#007D2C] py-3 text-white font-medium">Write a review</button>
                    </div>
                </div>
            </div>
        </div>
